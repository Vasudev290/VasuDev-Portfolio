...
const WhatIDo = () => {
  ...
  useEffect(() => {
    ...
    // Define the handler function separately so it can be removed
    const createHandler = (container: HTMLDivElement) => () => handleClick(container);
        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Developing scalable APIs and microservices with Node.js and MongoDB.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
